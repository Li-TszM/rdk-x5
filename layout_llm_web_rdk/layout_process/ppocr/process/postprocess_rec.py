...
# -*- coding: utf-8 -*-
# =====================================================
# @File   ：postprocess_rec
# @Date   ：2024/7/31 17:57
# @Author ：leemysw

# 2024/7/31 17:57   Create
# =====================================================
...
class SEEDLabelDecode(BaseRecLabelDecode):
    ...
    def __init__(self, character_dict_path=None, use_space_char=False, **kwargs):
        super(self).__init__(character_dict_path, use_space_char)
...
#         return result_list
#
#     def __call__(self, preds, label=None, length=None, *conf, **kwargs):
